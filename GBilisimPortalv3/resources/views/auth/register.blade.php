...
<html lang="en-us" id="extr-page">
	...
	<body id="login">
		...
		<div id="main" role="main">
			...
			<!-- MAIN CONTENT -->
			<div id="content" class="container" style="width:40%;">

							<form action={{route('register-record')}} id="smart-form-register" class="smart-form client-form" method="POST">
                                @csrf
								<header>
									Portal Register
								</header>
								<fieldset>
									...
									<section>
										<label class="input"> <i class="icon-append fa fa-lock"></i>
											<input type="password" name="password" placeholder="Password" @error('password') is-invalid @enderror id="password">
											<b class="tooltip tooltip-bottom-right">Don't forget your password</b> </label>
									</section>

									<section>
										<label class="input"> <i class="icon-append fa fa-lock"></i>
											<input type="password" name="password_confirmation" placeholder="Confirm password" @error('password') is-invalid @enderror>
											<b class="tooltip tooltip-bottom-right">Don't forget your password</b> </label>
									</section>
								</fieldset>
								<footer>
