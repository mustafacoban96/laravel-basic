...
<div id="panel-2" class="panel">
    <div class="panel-hdr">
        <h2>
            Personel <span class="fw-300"><i>Güncelle</i></span>
        </h2>
    ...
    <div class="panel-container show">
        ...
        <div class="panel-content p-0">
            <form action={{route('update',$personel->id)}} method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="panel-content">
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="date" class="form-control " name="is_ayrilma_tarihi" value="{{$personel->is_ayrilma_tarihi}}" disabled> 
                                </div>
                            </div>
                            <div class="col-md-7 mb-3">
                                <label class="form-label" for="validationCustom01">İşten Ayrilma Tarihi</label>
                            <input type="text" class="form-control" id="validationCustom01" placeholder="İşten Ayrılma Nedeni" name="isten_ayrilma_nedeni" value="{{$personel->isten_ayrilma_nedeni}}" disabled>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                ...
                <div class="panel-content border-faded border-left-0 border-right-0 border-bottom-0 d-flex flex-row align-items-center">
                    <button class="btn btn-success ml-auto" type="submit" id="js-sweetalert2-example-6">Güncelle</button>
                </div>
            </form>
            <div class="row">
                        ...
                        <table class="table m-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('adminFileDownload',$file->id)}}" class="btn btn-sm btn-success">
                                    ...
                                    <div class="demo">
                                        <!-- Small modal -->
                                        <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#default-example-modal-sm">
                                        ...
                                        <div class="modal-dialog modal-sm" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{route('adminFileDelete',$file->id)}}" method="POST">
                                                        @csrf
                                                        @method("DELETE")
