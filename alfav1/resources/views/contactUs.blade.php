        ...
        <div class="contact-form">
            <form action="">
                ...
                <Select>
                    ...
                    <option value="">Atlet Çanta</option>
                    <option value="">Alttan Körüklü Çanta</option>
                    <option value="">Alttan ve Yandan Körüklü Çanta</option>
                    <option value="">El Geçmeli Çanta</option>
                    <option value="">Düz Çanta</option>
                </Select>

                <input type="text"  placeholder="Name Surname">
                <input type="text"  placeholder="Phone Number">
                <input type="email" placeholder="Email">
                <textarea placeholder="You can write your message" rows="10"></textarea>
